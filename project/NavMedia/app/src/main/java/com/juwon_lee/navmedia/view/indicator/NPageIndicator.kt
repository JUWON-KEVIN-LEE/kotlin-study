package com.juwon_lee.navmedia.view.indicator
...
class NPageIndicator @JvmOverloads constructor(
    ...
    var mIndicatorRadius: Float = 0f
    var mCurrentIndicatorRadius: Float = 0f
    ...
    private fun measureHeight(heightMeasureSpec: Int): Int {
        ...
        Log.d("JUWONLEE", "height: " + result)
        return result
    }

    override fun onDraw(canvas: Canvas?) {
        super.onDraw(canvas)
        Log.d("JUWONLEE", "onDraw : $mCount")
    ...
    override fun onPageScrolled(position: Int, positionOffset: Float, positionOffsetPixels: Int) {
        Log.d("JUWONLEE", "onPageScrolled: " + position)
