...
public class NPlayerView extends FrameLayout implements GestureListener {
    ...
    public NPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        componentListener = new NPlayerView.ComponentListener();
